...
public class ComputerPlayer4x4 extends TicTacToePlayer4x4 {
    @Override
    public void playItsMove(ArrayList<Button> buttons, Button b, TicTacToeReferee4x4 ref) {
        ...
        // Step 1: Get input randomly (an int from 1 to 16).
        int intForComputerPlayer = rand.nextInt(16) + 1;
        ...
        while ((ref.playerPositions.contains(intForComputerPlayer) ||
            ...
            intForComputerPlayer = rand.nextInt(16) + 1;
        }
